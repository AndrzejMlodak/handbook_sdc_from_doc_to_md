...
$$
\text{CTBIL}(F,G;W,K)=\sum_{\{V_{ji}\cdots V_{jt}\} f\subseteq W\atop|\{V_{ji}\cdots V_{jt}\}|\leq K}\sum_{i_1\cdots i_t}|x^F_{i_1\cdots i_t}-x^G_{i_1\cdots i_t} | \quad (3.5.6)
$$
...
$$
H\left(V|V^'=j\right)=-\sum_{i=1}^n{p\left(V=i|V^'=j\right)\text{log}p}\left(V=i|V^'=j|\right) \quad(3.5.7)
$$
...
$$
\gamma=\frac{1}{\sqrt{2}}\sqrt{\sum_{j=1}^{m_c}{\left(\frac{\rho_{jj}^{(-1)}}{\sqrt{\sum_{l=1}^m{\left(\rho_{ll}^{(-1)}\right)^2}}}-\frac{\rho_{jj}^{*(-1)}}{\sqrt{\sum_{l=1}^m{\left(\rho_{ll}^{*(-1)}\right)^2}}}\right)^2}}\in [0,1]. \quad (3.5.8)
$$
...
$$
d({x_{ij}}^',x_{ij})=\frac{\mathfrak{r}(x_{ij}^',x_{ij})}{\mathfrak{r}_j-1}, (3.5.10)
$$
...
$$d(x_{ij}^',x_{ij})=|x_{ij}^'-x_{ij}|/\max_{k=1,2,\ldots,n}⁡|x_{kj}^'-x_{kj}|,$$ (3.5.11)
or
$$d(x_{ij}^',x_{ij})=(x_{ij}^'-x_{ij})^2/\max_{k=1,2,\lots,n}⁡(x_{kj}^'-x_{kj})^2,$$ (3.5.12)
...
$$
d(x_{ij}^',x_{ij})=\frac{2}{\pi}\arctan|x_{ij}^'-x_{ij}|.\quad (3.5.13)
$$
...
$$
\lambda=\sum_{j=1}^m{\sum_{i=1}^n{\frac{d(x_{ij}^',x_{ij})}{mn}}}\in [0,1], \quad (3.5.14)
$$
...
$$
\lambda_j=\sum_{i=1}^n{\frac{d(x_{ij}^',x_{ij})}{n}}\in [0,1],    (3.5.15)
$$
$j=1,2,\ldots,m$.
