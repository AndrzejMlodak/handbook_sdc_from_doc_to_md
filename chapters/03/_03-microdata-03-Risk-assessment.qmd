...
The focus of these methods and this section of the handbook is for microdata samples from social surveys. For microdata samples from censuses or registers the disclosure risk is known. Business survey microdata are not typically released due to their disclosive nature (skewed distributions or very small number of units sampled from some areas). We make some suggestions on practical implementation and we give examples of real datasets and ways in which risk assessment could be carried out.
